namespace SarahsNovel {
  export async function Scene_1(): ƒS.SceneReturn {
    ...
    await ƒS.Character.show(characters.kind, characters.kind.pose.hatIdee, ƒS.positionPercent(70, 100));
    ...
    switch (dialogueElement) {
      ...
      case dialogue.isayYes:
        ...
        await ƒS.Character.animate(characters.kind, characters.kind.pose.hatIdee, getAnimation());
        break;
